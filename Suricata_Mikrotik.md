...
Para ello como se puede observar en el documento de [Planificación de la Red de una empresa](./Planificación_de_la_Red_de_una_empresa.md), en la fase 3 hay conectado un equipo kali linux al router master.
